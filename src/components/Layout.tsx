            ...
            {navigation.map((item) => {
              ...
              return (
                <Link
                  ...
                  onClick={() => setSidebarOpen(false)}
                >
                  <item.icon className={`mr-3 h-5 w-5 ${isActive ? 'text-white' : 'text-gray-500 group-hover:text-primary-600'}`} />
                  <div>
          ...
          <nav className="flex-1 space-y-3 px-4 py-8">
            {navigation.map((item) => {
              ...
              return (
                ...
                >
                  <item.icon className={`mr-4 h-6 w-6 ${isActive ? 'text-white' : 'text-gray-500 group-hover:text-primary-600'}`} />
                  <div>
